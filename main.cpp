...
int main(void)
{
    ...
    FileReaderToy::add_all_connections_coordinates("D:\\FEUP 2ano\\2 semestre\\Desenho de algoritmos\\DAProj2_v2\\DA2proj-v1\\files\\Extra_Fully_Connected_Graphs\\Extra_Fully_Connected_Graphs\\edges_900.csv", current_graph,0);
    ...
    std::vector<int> a = tsp_realworld(current_graph,0,3, 0.8);
